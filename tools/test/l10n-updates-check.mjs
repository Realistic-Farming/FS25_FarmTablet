// l10n-updates-check.mjs - MAINTENANCE row 105's text bar for the Updates app (batch 10 of the remaining
// apps in the tablet translation wave; the pattern of l10n-soil-nutrient-check.mjs, #195).
//
// One app: the version history is long enough to be a batch of its own.
//   - Updates (UpdatesApp.lua): the help page, the header and every changelog line, drawn through the
//     app's own ftSafeText. Its CHANGELOG table is built when the file loads, after the game has read
//     the mod's l10n (mods.lua loadModDesc reads it at the mod scan, before loadMod sources any script).
...
//
// Usage:  node tools/test/l10n-updates-check.mjs             Exit: 0 clean, 1 any failure.
...
const KEYS = [
  "ft_auto_updates", "ft_changelog_100_new_1", "ft_changelog_112_fix_1", "ft_changelog_112_new_1",
  "ft_changelog_210_new_1", "ft_changelog_210_new_2", "ft_changelog_210_new_3", "ft_changelog_210_new_4",
  "ft_changelog_212_new_1", "ft_changelog_212_new_2", "ft_changelog_212_new_3", "ft_changelog_213_fix_1",
  "ft_changelog_213_fix_2", "ft_changelog_213_new_1", "ft_changelog_214_fix_1", "ft_changelog_214_new_1",
  "ft_changelog_214_new_2", "ft_changelog_214_new_3", "ft_changelog_215_fix_1", "ft_changelog_215_new_1",
  "ft_changelog_217_fix_1", "ft_changelog_217_new_1", "ft_changelog_217_new_2", "ft_changelog_217_new_3",
  "ft_changelog_217_new_4", "ft_changelog_218_fix_1", "ft_changelog_218_new_1", "ft_changelog_218_new_2",
  "ft_changelog_218_new_3", "ft_changelog_218_new_4", "ft_changelog_219_imp_1", "ft_changelog_219_new_1",
  "ft_changelog_220_imp_1", "ft_changelog_220_new_1", "ft_changelog_2323_fix_1", "ft_changelog_2323_fix_2",
  "ft_changelog_2323_fix_3", "ft_changelog_2323_imp_1", "ft_changelog_2324_imp_1", "ft_changelog_2324_new_1",
  "ft_changelog_240_imp_1", "ft_changelog_240_new_1", "ft_changelog_240_new_2", "ft_changelog_240_new_3",
  "ft_changelog_250_imp_1", "ft_changelog_250_imp_2", "ft_changelog_250_new_1", "ft_changelog_250_new_2",
  "ft_changelog_250_new_3", "ft_changelog_250_new_4", "ft_changelog_251_imp_1", "ft_changelog_251_imp_2",
  "ft_changelog_251_imp_3", "ft_changelog_251_new_1", "ft_changelog_251_new_2", "ft_changelog_251_new_3",
  "ft_changelog_251_new_4", "ft_changelog_253_fix_1", "ft_changelog_253_imp_1", "ft_changelog_253_imp_2",
  "ft_changelog_253_imp_3", "ft_changelog_253_new_1", "ft_changelog_253_new_2", "ft_changelog_253_new_3",
  "ft_changelog_253_new_4", "ft_updates_fixed", "ft_updates_help_history_body", "ft_updates_help_history_title",
  "ft_updates_help_structure_body", "ft_updates_help_structure_title", "ft_updates_improved", "ft_updates_new",
  "ft_updates_version", "ft_updates_version_history",
];
...
const ALLOW = {
  "da:ft_updates_version": "Version is the Danish word",
  "de:ft_updates_version": "Version is the German word",
  "fc:ft_updates_version": "Version is the French word",
  "fr:ft_updates_version": "Version is the French word",
  "sv:ft_updates_version": "Version is the Swedish word",
  "nl:ft_auto_updates": "Updates is the Dutch word (the app's own Dutch name, ft_ui_app_updates)",
};
...
const CONTAINS = [
  ["ft_updates_help_structure_body", "ft_updates_new"], ["ft_updates_help_structure_body", "ft_updates_improved"],
  ["ft_updates_help_structure_body", "ft_updates_fixed"],
];
...
const SOURCES = [
  {"file": "src/apps/UpdatesApp.lua", "keyFns": ["ftSafeText"], "literals": true},
];
...
if (failures.length > 0) {
  ...
  console.log(`l10n-updates: ${failures.length} failure(s) over ${checked} entries (${KEYS.length} keys x ${locales.length} locales)`);
  process.exit(1);
}
console.log(`l10n-updates: PASS - ${checked} entries checked (${KEYS.length} keys x ${locales.length} locales), ${Object.keys(ALLOW).length} allowed identical pairs, ${Object.keys(ALLOW_ALL).length} own names; script rule: ${scriptChecked} values in ${locales.filter((l) => SCRIPT[l]).join(", ")}`);
