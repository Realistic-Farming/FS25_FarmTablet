// l10n-storage-usedplus-workshop-check.mjs - MAINTENANCE row 105's text bar for the Storage, Used Plus
// and Workshop apps (batch 4 of the remaining apps in the tablet translation wave; the
// pattern of l10n-farmstats-production-events-market-check.mjs, #187).
//
// A batch of three small apps, kept near #187's size (Tyson's ruling for this pass):
//   - Storage (StorageApp.lua);
//   - Used Plus (UsedPlusApp.lua);
...
//
// Usage:  node tools/test/l10n-storage-usedplus-workshop-check.mjs        Exit: 0 clean, 1 any failure.
...
const KEYS = [
  ...
  "ft_auto_active_loans_and_leases_arranged_through_usedplus", "ft_auto_active_sale_listings",
  "ft_auto_agent_shows_vehicle_name_asking_price_range_agent",
  "ft_auto_amounts_shown_in_litres_sorted_largest_first", "ft_auto_and_liquid_manure_tanks",
  "ft_auto_and_the_selected_vehicle_has_more_than_2_wear", "ft_auto_any_placeable_with_bulk_storage_you_own",
  "ft_auto_any_vehicle_within_35_metres_appears_automatically",
  "ft_auto_balance_manage_deals_in_the_usedplus_finance_menu", "ft_auto_best_sell_prices",
  "ft_auto_best_sell_prices_per_1_000_l", "ft_auto_between_25_and_75_of_the_listing_window",
  "ft_auto_breakdowns_repair_before_reaching_80", "ft_auto_capacity_e_g_78_390l_500l",
  "ft_auto_click_select_on_a_vehicle_to_pin_its_diagnostics_in",
  "ft_auto_click_to_instantly_restore_the_vehicle_to_new_condition",
  "ft_auto_component_wear_as_a_percentage_0_new_100_worn", "ft_auto_credit", "ft_auto_credit_score",
  "ft_auto_data_refreshes_every_3_seconds", "ft_auto_diagnostics", "ft_auto_each_crop_you_have_in_storage",
  "ft_auto_filled_time_elapsed_an_offer_can_arrive_any_time", "ft_auto_finance_deals", "ft_auto_fuel_2",
  "ft_auto_grain_silos_bunker_silos_silage_pits_manure_stores",
  "ft_auto_high_wear_reduces_vehicle_efficiency_and_can_cause",
  "ft_auto_higher_score_better_loan_terms_and_lower_interest",
  "ft_auto_install_fs25_usedplus_to_use_this_app", "ft_auto_inventory",
  "ft_auto_lists_all_crops_currently_stored_across_your_owned_silo",
  "ft_auto_lists_every_selling_station_and_its_current_price_for", "ft_auto_marketplace",
  "ft_auto_monthly_total", "ft_auto_nearby_vehicles", "ft_auto_no_active_listings", "ft_auto_no_silos_owned",
  "ft_auto_no_vehicles_within_35_m", "ft_auto_no_workshop_found_on_this_farm_repairs_disabled",
  "ft_auto_only_shown_when_2_stations_buy_that_crop",
  "ft_auto_only_shown_when_a_workshop_placeable_is_on_your_farm", "ft_auto_operating_hours",
  "ft_auto_orange_bar_offer_is_waiting_for_your_decision",
  "ft_auto_orange_peak_current_price_is_below_the_recorded_high",
  "ft_auto_peak_price_is_tracked_and_saved_per_savegame", "ft_auto_price_comparison",
  "ft_auto_price_comparison_all_stations", "ft_auto_prices_are_per_1_000_litres_refreshes_every_5_seconds",
  "ft_auto_progress_bar", "ft_auto_purchase_a_silo_to_track_stored_crops", "ft_auto_repair_button",
  "ft_auto_repair_vehicle", "ft_auto_repairs_available", "ft_auto_select_a_vehicle_above_to_inspect",
  "ft_auto_select_unpin", "ft_auto_shows_current_fuel_level_litres_remaining_and_tank",
  "ft_auto_shows_item_name_monthly_payment_and_remaining",
  "ft_auto_shows_the_best_available_sell_price_per_stored_crop", "ft_auto_silos_are_empty",
  "ft_auto_single_station_no_comparison_available", "ft_auto_stations_are_sorted_best_price_first",
  "ft_auto_storage", "ft_auto_the_panel_below_pinned_vehicles_stay_visible_even",
  "ft_auto_tier_and_how_far_through_the_listing_period_you_are", "ft_auto_unpin",
  "ft_auto_up_to_6_vehicles_are_shown_at_a_time", "ft_auto_usedplus_is_not_installed",
  "ft_auto_vehicles_you_have_listed_for_sale_through_a_usedplus",
  "ft_auto_walk_closer_to_a_machine_to_see_it_in_the_list", "ft_auto_walk_closer_to_a_vehicle_to_inspect_it",
  "ft_auto_wear_2", "ft_auto_what_counts_as_a_silo", "ft_auto_when_you_walk_away_click_unpin_to_release_it",
  "ft_auto_workshop", "ft_auto_your_farm_s_usedplus_credit_rating", "ft_storage_peak_fmt",
  "ft_storage_silo_one", "ft_storage_silos", "ft_usedplus_day_left", "ft_usedplus_days_left",
  "ft_usedplus_deal_detail_fmt", "ft_usedplus_hour_left", "ft_usedplus_hours_left", "ft_usedplus_offer",
  "ft_workshop_fuel_fmt", "ft_workshop_near_row_fmt", "ft_workshop_nearby_fmt", "ft_workshop_shop_one",
  "ft_workshop_shops", "ft_workshop_vehicle_nearby_one", "ft_workshop_vehicles_nearby",
];
...
const OTHER_PR = {
  "ft_auto_fuel_bar": "another bar's key (l10n-animals-contracts-fleet-check.mjs)",
  "ft_auto_green_30_yellow_65_red_65": "another bar's key (l10n-animals-contracts-fleet-check.mjs)",
  "ft_auto_green_50_yellow_20_red_20": "another bar's key (l10n-animals-contracts-fleet-check.mjs)",
  "ft_auto_integration": "another bar's key (l10n-farmstats-production-events-market-check.mjs)",
  "ft_auto_no_sell_price_data_found": "another bar's key (l10n-farmstats-production-events-market-check.mjs)",
  "ft_auto_select": "another bar's key (l10n-rotation-sysset-prostaff-check.mjs)",
  "ft_auto_usedplus": "another bar's key (l10n-appstore-check.mjs)",
  "ft_auto_vehicle_2": "another bar's key (l10n-farmstats-production-events-market-check.mjs)",
  "ft_auto_wear_bar": "another bar's key (l10n-animals-contracts-fleet-check.mjs)",
};
...
const SOURCES = [
  {"file": "src/apps/StorageApp.lua", "keyFns": ["l10n", "l10nFormat"], "literals": true},
  {"file": "src/apps/UsedPlusApp.lua", "keyFns": ["l10n", "l10nFormat"], "literals": true},
  {"file": "src/apps/WorkshopApp.lua", "keyFns": ["l10n", "l10nFormat"], "literals": true},
];
...
if (failures.length > 0) {
  ...
  console.log(`l10n-storage-usedplus-workshop: ${failures.length} failure(s) over ${checked} entries (${KEYS.length} keys x ${locales.length} locales)`);
  process.exit(1);
}
console.log(`l10n-storage-usedplus-workshop: PASS - ${checked} entries checked (${KEYS.length} keys x ${locales.length} locales), ${Object.keys(ALLOW).length} allowed identical pairs, ${Object.keys(ALLOW_ALL).length} own names; script rule: ${scriptChecked} values in ${locales.filter((l) => SCRIPT[l]).join(", ")}`);
