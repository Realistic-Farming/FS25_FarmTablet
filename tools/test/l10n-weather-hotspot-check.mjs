// l10n-weather-hotspot-check.mjs - MAINTENANCE row 105's text bar for the Weather and Hotspot Manager
// apps (batch 5 of the remaining apps in the tablet translation wave; the pattern of
// l10n-storage-usedplus-workshop-check.mjs, #188).
//
// Two apps, kept near #187's size (Tyson's ruling for this pass):
//   - Weather (WeatherApp.lua);
//   - Hotspot Manager (HotspotManagerApp.lua).
...
//
// Usage:  node tools/test/l10n-weather-hotspot-check.mjs        Exit: 0 clean, 1 any failure.
...
const KEYS = [
  "ft_auto_ai", "ft_auto_animal", "ft_auto_clear_2", "ft_auto_clear_all", "ft_auto_cloud",
  "ft_auto_cloud_cover_2", "ft_auto_cold", "ft_auto_combine", "ft_auto_conditions", "ft_auto_cool",
  "ft_auto_environment_not_loaded_yet", "ft_auto_fog", "ft_auto_fog_2", "ft_auto_forecast",
  ...
  "ft_hotspot_help_what_body", "ft_hotspot_list_heading", "ft_hotspot_none", "ft_hotspot_pin_added",
  "ft_hotspot_pin_name", "ft_hotspot_remove", "ft_hotspot_remove_fmt", "ft_hotspot_removed",
  "ft_hotspot_removed_one", "ft_hotspot_tick_first", "ft_hotspot_total_fmt", "ft_weather_cond_clear",
  "ft_weather_day_plus_fmt", "ft_weather_dial_note", "ft_weather_forecast_days_fmt",
  "ft_weather_forecast_engine", "ft_weather_forecast_projected", "ft_weather_help_condition_body",
  "ft_weather_help_condition_title", "ft_weather_help_dial_body", "ft_weather_help_dial_title",
  "ft_weather_help_forecast_body", "ft_weather_help_readings_body", "ft_weather_help_readings_title",
  "ft_weather_help_temperature_body", "ft_weather_help_weatherguard_body", "ft_weather_mode_arid",
  "ft_weather_mode_normal", "ft_weather_mode_real", "ft_weather_mode_wet", "ft_weather_notice_admin_only",
  "ft_weather_notice_refused", "ft_weather_rain_chance_fmt", "ft_weather_rain_intensity_fmt",
  "ft_weather_rain_light", "ft_weather_rain_moderate", "ft_weather_source_engine", "ft_weather_source_wg",
  "ft_weather_wind_kmh_1f_fmt", "ft_weather_wind_kmh_fmt", "ft_weather_world_weather",
];
...
const ALLOW = {
  "br:ft_auto_animal": "Animal is the Portuguese word",
  "br:ft_weather_mode_normal": "Normal is the Portuguese word",
  "br:ft_weather_source_wg": "via is the Portuguese word, and WeatherGuard the companion mod's name",
  "br:ft_weather_wind_kmh_1f_fmt": "a number and the speed sign km/h, which the base game writes the same in br (unit_kmh, dataS/l10n/l10n_br.xml)",
  "br:ft_weather_wind_kmh_fmt": "a number and the speed sign km/h, which the base game writes the same in br (unit_kmh, dataS/l10n/l10n_br.xml)",
  "cz:ft_weather_wind_kmh_1f_fmt": "a number and the speed sign km/h, which the base game writes the same in cz (unit_kmh, dataS/l10n/l10n_cz.xml)",
  "cz:ft_weather_wind_kmh_fmt": "a number and the speed sign km/h, which the base game writes the same in cz (unit_kmh, dataS/l10n/l10n_cz.xml)",
  "de:ft_auto_mild": "Mild is the German word",
  "de:ft_auto_shop": "Shop is the German word",
  "de:ft_auto_warm": "Warm is the German word",
  "de:ft_auto_wind": "WIND is the German word",
  "de:ft_weather_mode_normal": "Normal is the German word",
  "de:ft_weather_wind_kmh_1f_fmt": "a number and the speed sign km/h, which the base game writes the same in de (unit_kmh, dataS/l10n/l10n_de.xml)",
  "de:ft_weather_wind_kmh_fmt": "a number and the speed sign km/h, which the base game writes the same in de (unit_kmh, dataS/l10n/l10n_de.xml)",
  "ea:ft_auto_animal": "Animal is the Spanish word",
  "ea:ft_weather_mode_normal": "Normal is the Spanish word",
  "ea:ft_weather_wind_kmh_1f_fmt": "a number and the speed sign km/h, which the base game writes the same in ea (unit_kmh, dataS/l10n/l10n_ea.xml)",
  "ea:ft_weather_wind_kmh_fmt": "a number and the speed sign km/h, which the base game writes the same in ea (unit_kmh, dataS/l10n/l10n_ea.xml)",
  "es:ft_auto_animal": "Animal is the Spanish word",
  "es:ft_weather_mode_normal": "Normal is the Spanish word",
  "es:ft_weather_wind_kmh_1f_fmt": "a number and the speed sign km/h, which the base game writes the same in es (unit_kmh, dataS/l10n/l10n_es.xml)",
  "es:ft_weather_wind_kmh_fmt": "a number and the speed sign km/h, which the base game writes the same in es (unit_kmh, dataS/l10n/l10n_es.xml)",
  "fc:ft_auto_animal": "Animal is the French word",
  "fc:ft_auto_conditions": "CONDITIONS is the French word",
  "fc:ft_auto_mission": "Mission is the French word",
  "fc:ft_weather_mode_normal": "Normal is the French word",
  "fc:ft_weather_source_wg": "via is the French word, and WeatherGuard the companion mod's name",
  "fc:ft_weather_wind_kmh_1f_fmt": "a number and the speed sign km/h, which the base game writes the same in fc (unit_kmh, dataS/l10n/l10n_fc.xml)",
  "fc:ft_weather_wind_kmh_fmt": "a number and the speed sign km/h, which the base game writes the same in fc (unit_kmh, dataS/l10n/l10n_fc.xml)",
  "fi:ft_weather_wind_kmh_1f_fmt": "a number and the speed sign km/h, which the base game writes the same in fi (unit_kmh, dataS/l10n/l10n_fi.xml)",
  "fi:ft_weather_wind_kmh_fmt": "a number and the speed sign km/h, which the base game writes the same in fi (unit_kmh, dataS/l10n/l10n_fi.xml)",
  "fr:ft_auto_animal": "Animal is the French word",
  "fr:ft_auto_conditions": "CONDITIONS is the French word",
  "fr:ft_auto_mission": "Mission is the French word",
  "fr:ft_weather_mode_normal": "Normal is the French word",
  "fr:ft_weather_source_wg": "via is the French word, and WeatherGuard the companion mod's name",
  "fr:ft_weather_wind_kmh_1f_fmt": "a number and the speed sign km/h, which the base game writes the same in fr (unit_kmh, dataS/l10n/l10n_fr.xml)",
  "fr:ft_weather_wind_kmh_fmt": "a number and the speed sign km/h, which the base game writes the same in fr (unit_kmh, dataS/l10n/l10n_fr.xml)",
  "hu:ft_weather_wind_kmh_1f_fmt": "a number and the speed sign km/h, which the base game writes the same in hu (unit_kmh, dataS/l10n/l10n_hu.xml)",
  "hu:ft_weather_wind_kmh_fmt": "a number and the speed sign km/h, which the base game writes the same in hu (unit_kmh, dataS/l10n/l10n_hu.xml)",
  "id:ft_auto_trailer": "Trailer is the Indonesian word",
  "id:ft_weather_mode_normal": "Normal is the Indonesian word",
  "it:ft_weather_wind_kmh_1f_fmt": "a number and the speed sign km/h, which the base game writes the same in it (unit_kmh, dataS/l10n/l10n_it.xml)",
  "it:ft_weather_wind_kmh_fmt": "a number and the speed sign km/h, which the base game writes the same in it (unit_kmh, dataS/l10n/l10n_it.xml)",
  "jp:ft_weather_wind_kmh_1f_fmt": "a number and the speed sign km/h, which the base game writes the same in jp (unit_kmh, dataS/l10n/l10n_jp.xml)",
  "jp:ft_weather_wind_kmh_fmt": "a number and the speed sign km/h, which the base game writes the same in jp (unit_kmh, dataS/l10n/l10n_jp.xml)",
  "kr:ft_weather_wind_kmh_1f_fmt": "a number and the speed sign km/h, which the base game writes the same in kr (unit_kmh, dataS/l10n/l10n_kr.xml)",
  "kr:ft_weather_wind_kmh_fmt": "a number and the speed sign km/h, which the base game writes the same in kr (unit_kmh, dataS/l10n/l10n_kr.xml)",
  "nl:ft_auto_warm": "Warm is the Dutch word",
  "nl:ft_auto_wind": "WIND is the Dutch word",
  "nl:ft_weather_source_wg": "via is the Dutch word, and WeatherGuard the companion mod's name",
  "pl:ft_weather_wind_kmh_1f_fmt": "a number and the speed sign km/h, which the base game writes the same in pl (unit_kmh, dataS/l10n/l10n_pl.xml)",
  "pl:ft_weather_wind_kmh_fmt": "a number and the speed sign km/h, which the base game writes the same in pl (unit_kmh, dataS/l10n/l10n_pl.xml)",
  "pt:ft_auto_animal": "Animal is the Portuguese word",
  "pt:ft_weather_mode_normal": "Normal is the Portuguese word",
  "pt:ft_weather_source_wg": "via is the Portuguese word, and WeatherGuard the companion mod's name",
  "pt:ft_weather_wind_kmh_1f_fmt": "a number and the speed sign km/h, which the base game writes the same in pt (unit_kmh, dataS/l10n/l10n_pt.xml)",
  "pt:ft_weather_wind_kmh_fmt": "a number and the speed sign km/h, which the base game writes the same in pt (unit_kmh, dataS/l10n/l10n_pt.xml)",
  "ro:ft_auto_animal": "Animal is the Romanian word",
  "ro:ft_weather_mode_arid": "Arid is the Romanian word",
  "ro:ft_weather_mode_normal": "Normal is the Romanian word",
  "ro:ft_weather_mode_real": "Real is the Romanian word",
  "ro:ft_weather_wind_kmh_1f_fmt": "a number and the speed sign km/h, which the base game writes the same in ro (unit_kmh, dataS/l10n/l10n_ro.xml)",
  "ro:ft_weather_wind_kmh_fmt": "a number and the speed sign km/h, which the base game writes the same in ro (unit_kmh, dataS/l10n/l10n_ro.xml)",
  "sv:ft_weather_wind_kmh_1f_fmt": "a number and the speed sign km/h, which the base game writes the same in sv (unit_kmh, dataS/l10n/l10n_sv.xml)",
  "sv:ft_weather_wind_kmh_fmt": "a number and the speed sign km/h, which the base game writes the same in sv (unit_kmh, dataS/l10n/l10n_sv.xml)",
  "tr:ft_weather_mode_normal": "Normal is the Turkish word",
  "vi:ft_weather_wind_kmh_1f_fmt": "a number and the speed sign km/h, which the base game writes the same in vi (unit_kmh, dataS/l10n/l10n_vi.xml)",
  "vi:ft_weather_wind_kmh_fmt": "a number and the speed sign km/h, which the base game writes the same in vi (unit_kmh, dataS/l10n/l10n_vi.xml)",
};
...
const OTHER_PR = {
  ...
  "ft_auto_field_3": "another bar's key (l10n-farmstats-production-events-market-check.mjs)",
  "ft_auto_production": "another bar's key (l10n-farmstats-production-events-market-check.mjs)",
...
const NO_KEY = {
  "WEATHERGUARD": "the companion mod's own name (FS25_WeatherGuard), kept in every language",
  "?": "the unknown-condition mark, a symbol",
};
...
const SOURCES = [
  {"file": "src/apps/WeatherApp.lua", "keyFns": ["l10n", "l10nFormat"], "literals": true, "drawnTables": ["condLabel"]},
  {"file": "src/apps/HotspotManagerApp.lua", "keyFns": ["l10n", "l10nFormat"], "literals": true},
];
...
if (failures.length > 0) {
  ...
  console.log(`l10n-weather-hotspot: ${failures.length} failure(s) over ${checked} entries (${KEYS.length} keys x ${locales.length} locales)`);
  process.exit(1);
}
console.log(`l10n-weather-hotspot: PASS - ${checked} entries checked (${KEYS.length} keys x ${locales.length} locales), ${Object.keys(ALLOW).length} allowed identical pairs, ${Object.keys(ALLOW_ALL).length} own names; script rule: ${scriptChecked} values in ${locales.filter((l) => SCRIPT[l]).join(", ")}`);
