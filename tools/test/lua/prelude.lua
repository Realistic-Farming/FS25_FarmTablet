...
-- ── FarmTablet: engine surface the tablet files touch at load ──
-- Giants' Utils.appendedFunction (the app files hook mission and UI methods with it).
Utils = Utils or {}
...
RenderText = RenderText or { ALIGN_LEFT = 0, ALIGN_RIGHT = 1, ALIGN_CENTER = 2, VERTICAL_ALIGN_BASELINE = 0 }
...
getScreenAspectRatio = getScreenAspectRatio or function() return 16 / 9 end
